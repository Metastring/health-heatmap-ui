...
function Layers() {
  ...
  const { selectedLayers, setSelectedLayers, layersLoading } = useContext(
    LayerContext
  );
        ...
        <Box>
          ...
          <Stack className="layer-stack" marginTop="-28px">
            ...
            <LayerStack
              ...
              updateLayerOrder={onLayerOrderChange}
            />
          </Stack>
        </Box>
      ) : (
        <Box>
          ...
          >
            <Stack isInline spacing={2} mt="5px" justifyContent="space-between">
              ...
              <Text className="count-badge">
                {_.keys(selectedLayers).length}
              </Text>
            </Stack>
          </Box>
        </Box>
